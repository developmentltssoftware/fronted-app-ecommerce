...
const FlexBag = ({ children, bagEmpty }) => {
  return (
    <Flex
      pos={"sticky"}
      right={0}
    ...
    >
      ...
      <Flex align="center" overflowY="auto" maxH="350px" flexDirection="column">
        {!bagEmpty ? (
          <Flex w="full" align="center" justify="center" gap={1} flexDirection={'column'}>
            {children}
          </Flex>
        ) : (
          <>
